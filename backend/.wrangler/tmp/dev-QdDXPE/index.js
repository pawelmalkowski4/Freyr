...
var TIMEOUT_MS = 3e4;
async function generateContent(env, params) {
  ...
  try {
    ...
    if (err.name === "AbortError") {
      throw new GeminiError("Gemini timeout \u2014 spr\xF3buj ponownie.", 504);
    }
  ...
  if (typeof text !== "string" || text.length === 0) {
    throw new GeminiError("Gemini nie zwr\xF3ci\u0142 tre\u015Bci.", 502, data);
  }
  return text;
}
__name(generateContent, "generateContent");
function parseJsonResponse(raw2) {
  const cleaned = raw2.replace(/^\s*```(?:json)?\s*/i, "").replace(/\s*```\s*$/i, "").trim();
  try {
    return JSON.parse(cleaned);
  } catch {
    throw new GeminiError("Gemini zwr\xF3ci\u0142 niepoprawny JSON.", 502, raw2);
  }
}
...
// src/prompts.ts
var identifyPrompt = /* @__PURE__ */ __name(() => `Jeste\u015B botanikiem-zielarzem znaj\u0105cym uprawy epoki wiki\u0144skiej oraz wsp\xF3\u0142czesne ro\u015Bliny
...
2. Je\u015Bli ro\u015Blina by\u0142a znana Wikingom (np. len, j\u0119czmie\u0144, chmiel, cebula, sza\u0142wia,
   ...
   b\xF3b) \u2014 podaj staronordyjsk\u0105 nazw\u0119 w \`common_name_old_norse\`. Je\u015Bli nie masz pewno\u015Bci
   co do nazwy staronordyjskiej, zwr\xF3\u0107 \`null\` \u2014 NIE wymy\u015Blaj.
3. \`historical_use\`: je\u015Bli ro\u015Blina by\u0142a znana Wikingom, kr\xF3tki opis (\u017Cagle, ubi\xF3r,
   medycyna, rytua\u0142, jedzenie). Je\u015Bli to ro\u015Blina pozaeuropejska lub wprowadzona p\xF3\u017Aniej,
   wpisz "n/a".
...
6. \`optimal_conditions\`: realistyczne zakresy dla uprawy domowej/przydomowej.
   Jednostki: temperatura \xB0C, wilgotno\u015B\u0107 powietrza %, \u015Bwiat\u0142o lux, wilgotno\u015B\u0107 gleby %.
7. \`care_notes\`: 1\u20132 zdania po polsku, praktyczne wskaz\xF3wki piel\u0119gnacji.
8. \`visible_issues\`: lista widocznych problem\xF3w (\u017C\xF3\u0142kni\u0119cie, plamy, oznaki suszy) \u2014
...
Odpowiedz WY\u0141\u0104CZNIE poprawnym JSON zgodnym ze schematem. Polski j\u0119zyk w opisach.`, "identifyPrompt");
var formatOptimal = /* @__PURE__ */ __name((o) => `
- temperatura: ${o.temperature_c[0]}\u2013${o.temperature_c[1]}\xB0C
- wilgotno\u015B\u0107 powietrza: ${o.humidity_pct[0]}\u2013${o.humidity_pct[1]}%
- \u015Bwiat\u0142o: ${o.light_lux[0]}\u2013${o.light_lux[1]} lx
- wilgotno\u015B\u0107 gleby: ${o.soil_moisture_pct[0]}\u2013${o.soil_moisture_pct[1]}%`, "formatOptimal");
var formatSensor = /* @__PURE__ */ __name((s, label) => {
  if (!s) return `${label}: brak danych`;
  const parts = [];
  if (s.temperature_c != null) parts.push(`temp ${s.temperature_c.toFixed(1)}\xB0C`);
  ...
  return `${label}: ${parts.length > 0 ? parts.join(", ") : "brak odczyt\xF3w"}`;
}, "formatSensor");
var analyzePrompt = /* @__PURE__ */ __name((params) => {
  const { species, oldNorseName, optimal, current, avg24h, mode, photo } = params;
  const styleBlock = mode === "saga" ? `TRYB: saga. Oce\u0144 stan ro\u015Bliny jak stary skald-zielarz siedz\u0105cy przy ogniu.
W polu \`message\` u\u017Cywaj stylizacji: odwo\u0142ania do Freja/Frei, run, p\xF3r roku wg
kalendarza wiki\u0144skiego \u2014 ale zachowaj konkret (liczby!). Pole \`actions\` ZAWSZE
strukturalne i pragmatyczne, bez stylizacji. Max 150 s\u0142\xF3w w \`message\`.` : `TRYB: plain. W \`message\` odpowiadaj zwyk\u0142ym polskim, konkretnie, bez stylizacji.
Bez odwo\u0142a\u0144 do bog\xF3w i sagi. Max 150 s\u0142\xF3w w \`message\`.`;
  const photoBlock = photo ? `
DO\u0141\u0104CZONE ZDJ\u0118CIE: U\u017Cytkownik do\u0142\u0105czy\u0142 aktualne zdj\u0119cie ro\u015Bliny. PRZYJRZYJ MU SI\u0118
UWA\u017BNIE. Sprawd\u017A: stan li\u015Bci (\u017C\xF3\u0142kni\u0119cie, plamy, przebarwienia, br\u0105zowe ko\u0144c\xF3wki,
zwi\u0119dni\u0119cie), oznaki szkodnik\xF3w (mszyce, prz\u0119dziorki, m\u0105czlik), nadmiar/niedob\xF3r
\u015Bwiat\u0142a (etiolacja, spalenia), stan pod\u0142o\u017Ca (ple\u015B\u0144, s\xF3l, nadmiar wody), oznaki
niedoboru (azot, \u017Celazo, magnez, potas). \u0141\u0105cz obserwacje wizualne z odczytami
czujnik\xF3w \u2014 cz\u0119sto obraz ujawnia problemy, kt\xF3rych liczby same nie pokazuj\u0105.
W \`issues\` i \`actions\` uwzgl\u0119dnij to, co WIDA\u0106 na zdj\u0119ciu. W \`message\` odwo\u0142aj
si\u0119 bezpo\u015Brednio do tego, co zaobserwowa\u0142e\u015B (np. "\u017B\xF3\u0142te ko\u0144c\xF3wki dolnych li\u015Bci
sugeruj\u0105 niedob\xF3r azotu \u2014 podaj naw\xF3z..." / "Br\u0105zowe plamy na kraw\u0119dziach to
...
var chatSystemPrompt = /* @__PURE__ */ __name((mode) => {
  if (mode === "saga") {
    return `Jeste\u015B skaldem-zielarzem \u2014 starym m\u0119drcem znaj\u0105cym ro\u015Bliny epoki wiki\u0144skiej
i wsp\xF3\u0142czesne zio\u0142a, warzywa i ro\u015Bliny domowe.

KONTEKST: W sekcji "Kontekst" poni\u017Cej MO\u017BE (ale nie musi) znajdowa\u0107 si\u0119 profil
konkretnej ro\u015Bliny jarla (gatunek, optymalne warunki, aktualne odczyty czujnik\xF3w).
- Je\u015Bli kontekst ro\u015Bliny jest obecny \u2014 to JEST ro\u015Blina, o kt\xF3rej rozmawiacie.
  Odno\u015B odpowied\u017A DO NIEJ, u\u017Cywaj jej imienia, por\xF3wnuj odczyty z optymalnymi
  zakresami, sugeruj konkretne dzia\u0142ania z liczbami.
- Je\u015Bli kontekstu ro\u015Bliny brak \u2014 jarl rozmawia og\xF3lnie. Je\u015Bli jego pytanie dotyczy
  konkretnej ro\u015Bliny, popro\u015B go o wybranie jej przyciskiem "+" obok pola wiadomo\u015Bci,
  albo odpowiedz og\xF3lnymi zasadami uprawy.

Odpowiadasz jarlu ZAWSZE konkretnie: liczby, akcje, terminy. Stylizacj\u0119 (odwo\u0142ania
do Freja/Frei, run Futhark, p\xF3r roku wed\u0142ug kalendarza wiki\u0144skiego) stosuj
UMIARKOWANIE \u2014 ma by\u0107 przypraw\u0105, nie g\u0142\xF3wnym daniem.

Zasady \u017Celazne:
- NIGDY nie wymy\u015Blaj fakt\xF3w historycznych. Je\u015Bli nie wiesz jak Wikingowie u\u017Cywali
  danej ro\u015Bliny, powiedz "Nie wiem, jak to ziele znali moi przodkowie" i daj konkretn\u0105
  wsp\xF3\u0142czesn\u0105 rad\u0119.
- NIE u\u017Cywaj list markdown ani nag\u0142\xF3wk\xF3w \u2014 odpowiadaj zwi\u0119z\u0142\u0105 proz\u0105.
- Max 120 s\u0142\xF3w na odpowied\u017A.
- Polski j\u0119zyk, lekko archaizowany.`;
  }
  return `Jeste\u015B rzeczowym asystentem ogrodnika.

KONTEKST: W sekcji "Kontekst" poni\u017Cej MO\u017BE (ale nie musi) znajdowa\u0107 si\u0119 profil
konkretnej ro\u015Bliny (gatunek, optymalne warunki, aktualne odczyty czujnik\xF3w).
- Je\u015Bli kontekst ro\u015Bliny jest obecny \u2014 to TA ro\u015Blina, o kt\xF3rej rozmawiasz z u\u017Cytkownikiem.
  U\u017Cywaj jej imienia, odno\u015B si\u0119 do jej odczyt\xF3w i optymalnych zakres\xF3w, proponuj
  konkretne dzia\u0142ania z liczbami (ml, cm, godziny).
- Je\u015Bli kontekstu ro\u015Bliny brak \u2014 u\u017Cytkownik rozmawia og\xF3lnie. Je\u015Bli pytanie dotyczy
  konkretnej ro\u015Bliny, popro\u015B go o wybranie jej przyciskiem "+" obok pola wiadomo\u015Bci,
  lub odpowiedz og\xF3lnymi wskaz\xF3wkami.

Odpowiadasz konkretnie, kr\xF3tko, po polsku. Bez stylizacji, bez odwo\u0142a\u0144 do bog\xF3w
i mitologii. Max 120 s\u0142\xF3w na odpowied\u017A.`;
}, "chatSystemPrompt");
var chatContextBlock = /* @__PURE__ */ __name((params) => {
...
var sagaPrompt = /* @__PURE__ */ __name((params) => {
  const { gardenName, plants, aggregates, events } = params;
  return `Ogr\xF3d: ${gardenName}
...
Napisz 2\u20134 zdania wpisu kronikarskiego w stylu sagi islandzkiej (Nj\xE1ls saga,
Egils saga). Zawiera\u0107:
- faktyczne wydarzenia z danych (nie wymy\u015Blaj),
- poetycki tytu\u0142 dnia (np. "Dzie\u0144, w kt\xF3rym len zapomnia\u0142 o wodzie"),
- subteln\u0105 m\u0105dro\u015B\u0107 lub obserwacj\u0119.

Skald oszcz\u0119dza s\u0142\xF3w. Max 80 s\u0142\xF3w w \`body\`. Polski j\u0119zyk, archaizowany lekko.
...
// src/schemas.ts
var identifyRequest = external_exports.object({
  image: external_exports.string().min(32, "Base64 image is too short")
});
var rangeSchema = external_exports.tuple([external_exports.number(), external_exports.number()]);
var optimalConditionsSchema = external_exports.object({
  temperature_c: rangeSchema,
  humidity_pct: rangeSchema,
  light_lux: rangeSchema,
  soil_moisture_pct: rangeSchema
});
var sensorSnapshotSchema = external_exports.object({
  temperature_c: external_exports.number().nullable().optional(),
  humidity_pct: external_exports.number().nullable().optional(),
  light_lux: external_exports.number().nullable().optional(),
  soil_moisture_pct: external_exports.number().nullable().optional()
}).passthrough();
var analyzeRequest = external_exports.object({
  species: external_exports.string().min(1),
  oldNorseName: external_exports.string().nullable().optional(),
  optimal: optimalConditionsSchema,
  current: sensorSnapshotSchema,
  avg24h: sensorSnapshotSchema.optional(),
  mode: external_exports.enum(["saga", "plain"]),
  photo: external_exports.string().min(32).optional()
});
var chatRequest = external_exports.object({
  sessionId: external_exports.string().min(1),
  plantId: external_exports.string().min(1),
  ...
  plant: external_exports.object({
    name: external_exports.string().optional(),
    species: external_exports.string().optional(),
    optimal: optimalConditionsSchema.optional()
  }).optional(),
  sensors: sensorSnapshotSchema.optional()
});
var sagaRequest = external_exports.object({
  gardenName: external_exports.string().min(1),
  plants: external_exports.array(external_exports.unknown()).default([]),
  aggregates: external_exports.record(external_exports.unknown()).default({}),
  events: external_exports.array(external_exports.unknown()).default([])
});
var numberRange = {
  type: "ARRAY",
  items: { type: "NUMBER" },
...
var detectMime = /* @__PURE__ */ __name((b64) => {
  if (b64.startsWith("/9j/")) return "image/jpeg";
  if (b64.startsWith("iVBORw0KGgo")) return "image/png";
  if (b64.startsWith("UklGR")) return "image/webp";
  return "image/jpeg";
}, "detectMime");
var identifyRoute = new Hono2().post(
  "/",
  ...
  async (c) => {
    ...
    if (parsed.common_name_old_norse === void 0) {
...
var detectMime2 = /* @__PURE__ */ __name((b64) => {
  if (b64.startsWith("/9j/")) return "image/jpeg";
  if (b64.startsWith("iVBORw0KGgo")) return "image/png";
  if (b64.startsWith("UklGR")) return "image/webp";
  return "image/jpeg";
}, "detectMime");
var analyzeRoute = new Hono2().post(
  "/",
  ...
  async (c) => {
    ...
    if (body.photo) {
      ...
      parts.push({ inlineData: { mimeType: detectMime2(stripped), data: stripped } });
    }
    const text = await generateContent(c.env, {
      contents: [
        {
...
// .wrangler/tmp/bundle-vbXjWV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vbXjWV/middleware-loader.entry.ts
